...
$sql_query1 = "SELECT * FROM devices AS D WHERE D.DeviceID = '$selecteddevice'";
...
if ($row['IsBorrowed']== 1){
	echo "<script> alert('Device not Available');parent.location.href='AdminRequestDevices.php';</script>";
}
else{
	...
	echo "<script> alert('Borrowed');parent.location.href='Admin.php';</script>";
}
?>
