...
if($_POST['DeviceName']!=null){
	...
	if($result == false)
		{
			echo "<script> alert('Database Error');parent.location.href='UserSummary.php';</script>";
			
		}
	if($numrow == 0){
		echo "<script> alert('No such Device');parent.location.href='UserSummary.php';</script>";
	}
	else{
...
<html>
<head>
	<link href="DeviceStatus.css" rel="stylesheet" type="text/css"/>
</head>
<body>
